...
const ProductCard = ({ product, onAddToCart }) => (
  <div className="border rounded-xl p-4 shadow-md bg-white hover:shadow-lg transition-all flex flex-col justify-between">
    ...
    <button
      ...
      className="mt-auto bg-indigo-600 text-white font-semibold py-2 px-6 rounded-md transition duration-300 ease-in-out transform hover:bg-indigo-700 hover:scale-105"
    >
      Add to Cart
    </button>
  </div>
